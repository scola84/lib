...
export class Formatter {
  static format (string, args = [], locale = 'en_US') {
    ...
    for (let i = 0; i < matches.length; i += 1) {
      [
        match, prefix, , , name, , position, type, , options = ''
...
if (typeof process === 'object') {
  formatter.n.setLocales(process.env.FORMATTER_LOCALES)
}

if (typeof window === 'object') {
  formatter.n.setLocales(window.FORMATTER_LOCALES)
}
