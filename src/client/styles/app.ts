...
export default css`
  ...
  :host([theme]) {
    ...
    --scola-node-fill-tsp-1: var(--scola-fill-tsp-a, rgba(255, 255, 255, 0.25));
    --scola-node-fill-tsp-2: var(--scola-fill-tsp-b, rgba(0, 0, 0, 0.25));
  ...
  :host([theme="scola-solid"][scheme="dark"]) {
    ...
    --scola-fill-tsp-a: rgba(255, 255, 255, 0.25);
    --scola-fill-tsp-b: rgba(0, 0, 0, 0.25);
