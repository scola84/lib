export default {
  ...
  auth_register_hotp_email_text: '$(user.email)s: $(otp)s',
  auth_register_hotp_sms_text: '$(user.email)s: $(otp)s',
  auth_register_identity_email_subject: 'Nieuw account',
  auth_register_identity_email_text: '$(user.email)s: $(token.hash)s',
